/**
 * @file degauss.c
 * @brief Degauss magnets using an SDDS specification file.
 *
 * Reads an SDDS file describing devices and degaussing parameters,
 * configures the appropriate subroutine records, and optionally starts,
 * stops, or queries the degaussing process.
 *
 * @section Usage
 * ```
 ...
 * | Option        | Description |
 * |---------------|-------------|
 * | `-query`      | Print the degaussing state of devices in the specification file. |
 * | `-configure`  | Configure records for degaussing but do not initiate. |
 * | `-stop`       | Halt degaussing of devices in the specification file. |
