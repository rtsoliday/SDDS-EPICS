...
%
% Hyperlink to a program's documentation using modern hyperref syntax.
% Renders text like `program()` and links to \label{program} in the manual.
...
\label{ManualPages}
\input{APSlogDaemon.tex}
\input{APSRunControl.tex}
\input{cavget.tex}
\input{cavput.tex}
\input{cawait.tex}
\input{degauss.tex}
